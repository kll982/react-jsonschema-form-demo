import { ColorPicker, DateTimePicker } from "../widgets";
const widgets = {
  // TimeWidget: DateTimePicker,
  // DateWidget: DateTimePicker,
  RangeWidget: DateTimePicker,
...
const testUiSchema = {
  "ui:order": ["type", "syncWithSelection", "range", "teaxarea", "*"],
  dateTimeRange: {
    "ui:options": {
      label: false,
    },
...
export { widgets, testSchema, testUiSchema };
